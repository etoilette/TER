...
class csg:
    ...
    Attributes:
        ...
        current_state: The current state of the controller.
    """
    # psc If you know all the attributes, make it dataclass too?
    # psc add typing and return types
    def __init__(self, aut: spot.twa_graph, states_bdds, edges_concsets, outputs):
        self.twa = aut
    ...
    def get_a_paretto_max_edge(self, inputs_val):
        ...
        # psc : Tries to fire a maximum number of transitions concurrently? Say a word
        # that we have no auto-concurrency for the moment?
...
def compute_outputs(bdd, outputs):
    ...
    Args:
        bdd: Input cube.
        outputs: bdd_vars of output APs as list or dict.
    ...
    while bdd_temp != buddy.bddtrue:
        ...
        if high == buddy.bddfalse:
            if top in outputs: # psc : if top is a list, having it sorted would be better to have O(1) test
                resu[top] = False
            bdd_temp = low
            continue
...
class petrinet:
    ...
    Attributes:
        ...
        map: The map of the Petri net. #psc what is the map of a Petri net?
...
# psc not sure what happens here. Why is this "char"-based
